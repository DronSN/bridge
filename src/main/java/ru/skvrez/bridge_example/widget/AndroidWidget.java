...
public class AndroidWidget implements PlayerControl {

    private static final Logger log = Logger.getLogger(AndroidWidget.class.getName());
    private static final String DELIMITER = "_____________________________________";
    private final Player player;
    private final List<Song> playList;
    private int songIndex;

    public AndroidWidget(Player player) {
        this.player = player;
